...
public class Switch02 {
    ...
    public static void main(String[] args) {
        ...
        //Bu örnekte equalIgnoreCase() kullanamazdik cunku esitlik durumu yok. "equalsIgnoreCase()" iki seyi karsilastirirken kullanilir.

        Scanner input = new Scanner(System.in);
        System.out.println("Ay ismini giriniz");
        String ayIsmi = input.next().toLowerCase();//"toLowerCase()" operatoru kullanicidan alinan karakterlerin hepsini kucuk harf olarak alir.
