...
public class TreeSet01 {
        ...
        Note : Tekrarsiz elemanlari Natural Order'da depolamak icin TreeSet kullanmak mantiklidir ama TreeSet'ler coook yavas calistigi icin
               biz elemanlari once HashSet'e depolariz sonra HashSet'i TreeSet'e cevirerek TreeSet'in yavas olma problemini aşmış oluruz.
    ...
    public static void main(String[] args) {
        ...
        System.out.println(end1 - start1);//1120000
        ...
        TreeSet myEmailsSorted = new TreeSet(myEmails);//Once HashSet ile datayi hizlica ekledik. Sonra onu TreeSet'e aktarıp order ettik.
                                                       //Boylece HashSet'in hizli data ekleme yetenegini kullanarak ve TreeSet'in de
                                                       // Natural Order yapma ozelliginden faydalanmıs olduk


        Long end2 = LocalTime.now().toNanoOfDay();
        System.out.println(end2 - end1);//138000
