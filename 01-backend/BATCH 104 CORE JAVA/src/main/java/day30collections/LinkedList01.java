...
public class LinkedList01 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println(names);//[Chris, Alexandre, Mark, Tom, Jeremy, Hans](ilk elemanı silmedi)
        ...
        */
        ...
        List boş oldugunda exception vermesini istiyorsaniz "pop", null vermesini istiyorsaniz "poll" kullanin.
