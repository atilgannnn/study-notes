...
public class Scanner01 {
    ...
    public static void main(String[] args) {
        ...
        /* Kullanicidan ilk, orta ve soy ismini alınız ve aşağıdaki formatta ekrana yazdiriniz.
        Ali Mert Can
        123456789
         */
...
//        String ilkIsim = input.next();//next() methodu kullanıcıdan String datası almak için kullanilir
