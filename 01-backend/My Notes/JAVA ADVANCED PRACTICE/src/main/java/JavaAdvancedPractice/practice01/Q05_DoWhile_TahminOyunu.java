package JavaAdvancedPractice.practice01;
...
public class Q05_DoWhile_TahminOyunu {
    ...
    public static void main(String[] args) {
        ...
        int counter = 0;
        System.out.println("Toplam hakkınız : 10");
        ...
        do {
            ...
            if (sayi == rastgeleSayi) {
                ...
                System.out.println(10 - counter + " hakkınız kaldı!");
            ...
            if (counter == 10) {
                ...
                System.out.println("Hakkınız bitti oyunu kaybettiniz\nTekrar oynamak için 1, çıkmak için herhangi bir sayi girin");
