...
public class StringManipulations01 {
    ...
    public static void main(String[] args) {
        ...
        //replaceFirst("a","*") kodu String'deki ilk "a" yi "*" e cevirir.
        //replace("a","*") kod String'deki tum "a" lari "*" e cevirir.
        String c= a.replaceFirst("a","*");
        System.out.println(c);

        //concat() methodu iki tane String'i birbirine yapistirmaya yarar. Her zaman cümelnin en sonuna ekler!
        //Concatenation islemi iki turlu yapilabilir. i) + ile ii) concat() ile
        //Java bir islem icin method üretmisse o methodu kullanmak "best practice"dir.
        ...
        //h.compareTo(i); kodu iki tane String'i alfabetik(lexicographic) olarak karsilastirir.
        ...
        //Java Document'e ulasmak icin Windows ==> ctrl e basili tutun   Mac ==> Command e basili tutunve mouse ile method ismine tiklayin.
        String n = a.repeat(5);
