...
public class DateTime02 {
    ...
    public static void main(String[] args) {
        ...
        //MM(Months) aylar icin kullanilir. "m" kucuk "m" (minutes) dakikalar icin kullanilir.
        ...
        DateTimeFormatter dtf8 = DateTimeFormatter.ofPattern("hh:mm a");// parantez icinde sona "a" koydugumuzda "a.m." veya "p.m." ekler.
