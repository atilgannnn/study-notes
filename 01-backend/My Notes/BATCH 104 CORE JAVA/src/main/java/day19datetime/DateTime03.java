...
public class DateTime03 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(myDate);//2011-04-13
         ...
         /*
            Java'da sabit datalari(Gun isimleri, ay isimleri, ABD'deki eyalet isimleri gibi etc.) depolamak ve gerektiginde kullanmak icin
            depolar olustururuz. Bu depolara "Enum" denir.

         */

        //Example 3: USA icin "Woow!", UK icin "Big", Canada icin "Cold", Turkey icin "Vatan", Germany icin "Araba", Rwanda icin "Cay" yazdirin.
