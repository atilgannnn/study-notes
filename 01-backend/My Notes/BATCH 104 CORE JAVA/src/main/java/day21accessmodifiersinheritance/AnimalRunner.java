...
public class AnimalRunner {
    ...
    2) Bir Class'i baska bir Class'in Child Class'i yapmak icin "extends" keyword kullanilir.
       İlk yazilan Class Child, ikinci yazilan Class parent olur.
    ...
    6) "private" method ve variable'lar Child Class'lar tarafindan kullanilamaz.
       "private" methods and variables cannot be used by Child Classes.
    ...
    7) 4 tip inheritance vardir
       ...
       iii) Multiple Inheritance : Bir Child'a coklu parents, Java bunu desteklemez(Java does not support Multiple Inheritance)
