...
public class Variables01 {
    ...
    //"Assignment(Atama) Operator" sagdaki degeri alır soldaki variable'in icine koyar
...
/*
     ...
     1)int: Integer'in kisaltmasi. Integer tam sayı demektir. 32 bit kullanır.
            Matematikte tam sayilarin basi ve sonu yoktur fakat Java'da tamsayilarin basi ve sonu vardir.
     ...
     5)float: Ondalikli sayilar icindir. 32 bit kulanır.
              "float" vigulden sonra 7 basamak icerebilir.
              "float" degerinde sona "f" veya "F" koymaniz gerekir.

     6)double: Ondalikli sayilar icindir. 64 bit kullanır.
               "double" virgulden sonra 16 basamak icerebilir.

     7)boolean: "true" veya "false" degerleri icin kullanilir.1 bit kullanır.
     ...
     8)char: Tek karakterler icin kullanilir. 16 bit kullanir.
      ...
      String: Isim, adres, kimlik numarasi gibi bir veya birden fazla karakter iceren degerlerde kullanilir.
              ...
              2)Primitive data type'lari Java tarafindan olusturulmustur,toplam 8 tanedir, biz Primitive data olusturamayiz.
                ...
                Non-Primitive sayılamayacak kadar coktur, cunku her developer Non-Primitive data type olusturabilir.
              3)Primitive data type isimleri kucuk harflerle baslar.
                Non-Primitive data type isimleri buyuk harfle baslar.
              4)Primitive Data type'lar memory'de farklı buyuklukte yerler kullanir.
