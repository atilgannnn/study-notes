...
public class Arrays01 {
    ...
    public static void main(String[] args) {
        ...
        //Arrays'lerin icine sadece primitive data tipleri ve "reference(stack memory adresleri)" lar yerlestirilebilir.
        //Bu reference lar üzerinden de String değerler çağirilir.
