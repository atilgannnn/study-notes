...
public class IfStatement03 {
    ...
    public static void main(String[] args) {
        ...
        //2. Yol:
        if(gun.equalsIgnoreCase("Pazar") || gun.equalsIgnoreCase("Cumartesi")){ //Kod standartlarinda parantez ici kodun kisa olmasi beklenir.
            System.out.println("Hafta sonu...");
        }else if(gun.equalsIgnoreCase("Pazartesi") ||
        ...
        if(haftaSonu){
            ...
            //Kod yazarken iki standart vardir. Kendini tekrar eden ifadeler yazmamak ve kısa ve öz yazmak. Buna "Clean Code" denir.
        }
