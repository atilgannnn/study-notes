...
public class TypeCasting01 {
    ...
    //Note: Kucuk data type'ini buyuk data type'ine çevirmeye "Auto Widening" denir.
    //Note: Buyuk data type'ini kucuk data type'ine çevirmeye "Explicit Narrowing" denir.
    ...
    public static void main(String[] args) {
        ...
        long newNumOfStudents = numOfStudents;//Auto Widening
