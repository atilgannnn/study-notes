...
public class Exceptions03 {
    ...
    1)Java Exception'lar olusturarak Developer'larin Java kurallarina uymalarini temin etmiştir.
    2)Biz de Application üretirken kendi Exception'larimizi olusturarak diger Developer'larin bizim ortaya koydugumuz kurallara
    uymalarini temin ederiz.
    3)Java'nin degil, bizim urettigimiz Exception'lara "Custom Exception" denir.
    4)Custom Exception'lar da "Runtime Exception" ve "CompileTimeException" olabilir.
    5)Custom "Runtime Exception" üretmek icin "extends "RunTimeException" deriz.
    5)Custom "CompileTime Exception" üretmek icin "extends Exception" deriz.
