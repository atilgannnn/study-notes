...
public class HashTable01 {
    ...
    3)HashTable, HashMap'lerden daha yavastir. Cunku HashTable'lar thread-safe(aynı anda birden fazla iş yapabilme becerisi)
    ve synchronized(Çoklu işlerin zaman kazandirabilecek şekilde sıralanabilmesi)'dir.
    ...
    5)HashTable'larda value "null" olamaz. Value'yu null yaparsaniz "NullPointerException" atar.
        ...
        Note : toString() method'u objeleri konsolda detaylari ile gorebilmek icin class'larin icinde olusturulur.
