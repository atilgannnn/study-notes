...
public class C02_LocalDateTime {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println(dtf.format(time.plusHours(2)));//00:36


        DateTimeFormatter dtf2 = DateTimeFormatter.ofPattern("hh:mm");
        System.out.println(dtf2.format(time.minusHours(1)));//09:36

        DateTimeFormatter dtf3 = DateTimeFormatter.ofPattern("hh:mm:ss");
        System.out.println(dtf3.format(time.minusHours(1)));//09:38:28
        ...
        System.out.println(dtf6.format(time2.plusHours(2)));//12:48:09
